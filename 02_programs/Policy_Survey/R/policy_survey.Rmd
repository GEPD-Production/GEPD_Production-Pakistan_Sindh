...
file_name <- "GEPD_PolicySurvey Final_Sindh Final.xlsx"
...
if  (str_to_lower(Sys.getenv("USERNAME")) == "wb631589" ){
   ...
   data_dir  <- "C:/Users/wb631589/OneDrive - WBG/GEPD-Confidential/General/Country_Data/GEPD_Production-Pakistan_Sindh/01_GEPD_raw_data/"
   expert_dir <-file.path(paste(project_folder,"GEPD_Production-Pakistan_Sindh/01_GEPD_raw_data/Policy_Survey/", sep="/"))
   processed_dir <-file.path(paste(project_folder,"GEPD_Production-Pakistan_Sindh/03_GEPD_processed_data/", sep="/"))
}
```
...
expert_dta_teachers_final <- expert_dta_teachers_final %>%
  mutate(teacher_attraction=read_var(A4),
         teacher_salary=((33820*12)/282512.9)) # GDP per capita from WDI
